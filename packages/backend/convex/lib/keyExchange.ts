...
export class KeyExchange {
  ...
  static async sealMessage(
    ...
    try {
      ...
      const nonce = generateRandomBytes(KeyExchange.NONCE_LENGTH);
  ...
  static async openMessage(
    ...
    try {
      ...
      const ciphertextBytes = base64ToUint8Array(sealedPayload.ciphertext);
      const nonceBytes = base64ToUint8Array(sealedPayload.nonce);
      const tagBytes = base64ToUint8Array(sealedPayload.tag);
...
// biome-ignore lint/complexity/noStaticOnlyClass: idk
