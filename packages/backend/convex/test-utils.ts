 ...
 * @internal
 */
export function setConvexModules(modules: Record<string, () => Promise<unknown>>): void {
 ...
 */
export function createConvexTest<Schema extends GenericSchema>(
  ...
  return convexTest(schema, _convexModules);
}